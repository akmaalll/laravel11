...
class NaiveCobaController extends Controller
{
    ...
    public function getJudulPengajuan($id)
    {
        try {
            ...
            // $dataToExport = [
            //     'Disarankan Lektor' => $sortDisarankanLektor,
            //     'Rekomendasi Lektor' => $sortRekomendasiLektor,
            //     'Disarankan Ahli' => $sortDisarankanAhli,
            //     'Rekomendasi Ahli' => $sortRekomendasiAhli,
            // ];
            // dd($dataToExport);

            // return Excel::download(new DataExport($dataToExport), 'hasil_sorting.xlsx');
            ...
            return view('admin.pembimbing.hasilAlgoritma', compact('dataPengajuan', 'datanassami', 'atribut', 'dataLatih', 'prob', 'nassami', 'psat', 'pStatus', 'results', 'sortDisarankanLektor', 'sortRekomendasiLektor', 'sortDisarankanAhli', 'sortRekomendasiAhli'));
